...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright MaxBright, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/BrightConvolver-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BrightConvolver-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BrightConvolver-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BrightConvolver-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BrightConvolver-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BrightConvolver-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/BrightConvolver-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/BrightConvolver.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BrightConvolver.iss",inplace=1):
